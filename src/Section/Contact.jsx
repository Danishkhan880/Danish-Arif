...
const Contact = React.forwardRef(function Contact(props, ref) {
  ...
  return (
    <section ref={ref} className="scroll-mt-28">
      ...
      <form action="https://formspree.io/f/xlgkqgje" method="POST" className="bg-[#1c1b19]/40 backdrop-blur-xl border border-white/[0.05] p-8 md:p-12 rounded-[2.5rem] shadow-2xl relative overflow-hidden group">
